...
public class PlayPingPong implements Runnable {
    ...
    private Handler [] mHandlerArray = new Handler [PingPong.values().length];
    ...
    class PingPongThread extends HandlerThread implements Handler.Callback {
        ...
        protected void onLooperPrepared() {
    		...
    		mHandlerArray[mMyType.ordinal()] = new Handler (this);
            ...
            if (mMyType == PingPong.PING){
            	Handler pingHandler = mHandlerArray[PingPong.PING.ordinal()];
            	Message msg = pingHandler.obtainMessage(PingPong.PONG.ordinal(), mHandlerArray[PingPong.PONG.ordinal()]);
        ...
        public boolean handleMessage(Message reqMsg) {
            ...
            if (mIterationsCompleted < mMaxIterations) {
            	...
            	if (reqMsg.what == PingPong.PONG.ordinal()){
                ...
                // @@ TODO - you fill in here.
            	mHandlerArray[mMyType.ordinal()].getLooper().quit();
            }
            ...
            Handler target = mHandlerArray[reqMsg.what];
            Message msg = target.obtainMessage(mMyType.ordinal(), mHandlerArray[mMyType.ordinal()]);
